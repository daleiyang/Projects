...
class Transformer(object):
    def __init__(self, seq_len, input_vocab_size, masked_input_vocab_size, 
                 ...
                 num_heads=4, num_blocks=3, lr=0.001, dev_info='/gpu:0', max_model_to_keep=2):
        ...
        # self.targets = tf.Print(self.targets, [self.targets], summarize=1000)
        ...
        with tf.device(dev_info):
            ...
            def bi_trans_layer(layer_name, layer_inputs, layer_inputs_reversed, hid_size_multiple=1):
                with tf.variable_scope(layer_name, reuse=tf.AUTO_REUSE):
                    ...
                    outputs_bw = tf.reverse_sequence(outputs_bw, self.sequence_length, seq_dim=1, batch_dim=0)
                    ...
                    combined_fw_bw = tf.concat([outputs_fw_sliced, outputs_bw[:, 1:, :]], 2)

                return combined_fw_bw
